...
public class WarriorsGuildConstants {
	...
	public static final int[] ANIMATED_ARMOR = { 4278, 4279, 4280, 4281, 4282, 4283, 4284 };

	public static final String[] ARMOR_TYPE = { "Bronze", "Iron", "Steel", "Black", "Mithril", "Adamant", "Rune" };

	public static final int[] DEFENDERS = { 8844, 8845, 8846, 8847, 8848, 8849, 8850, 20072 };
