...
public class RangedConstants {
	...
	public static Graphic getDrawbackGraphic(Player player) {
		...
		case SHOT:
			...
			AmmoData data = AmmoData.forId(ammo.getId());
			if (data == null) {
				return null;
			}
		...
		case THROWN:
			switch (weapon.getId()) {
			case 811:
				return new Graphic(1240, 12, 100);
			case 810:
				return new Graphic(1239, 12, 100);
			case 809:
				return new Graphic(1238, 12, 100);
			case 808:
				return new Graphic(1236, 12, 100);
			case 807:
				return new Graphic(1235, 12, 100);
			case 806:
				return new Graphic(1234, 12, 100);
			case 805:
	...
	public static Projectile getProjectile(Player player) {
		...
		case SHOT:
			...
			case 15241:
				Projectile p = new Projectile(2143);
				p.setStartHeight(23);
				p.setEndHeight(23);
				p.setCurve(0);
				return p;
			...
			if (AmmoData.forId(ammo.getId()) == null) {
				return null;
			}
			return AmmoData.forId(ammo.getId()).getProjectile();
		case THROWN:
			switch (weapon.getId()) {
			case 10034:
