package org.mystic.game.model.content.skill.crafting.craftable.impl;
...
public enum Hide implements Craftable {
	...
	private final Item use, with;

	private final CraftableItem[] items;

	private Hide(final Item use, final Item with, final CraftableItem... items) {
		this.use = use;
		this.with = with;
		this.items = items;
	}
	...
	static {
		for (Hide cuttable : values()) {
			HideCrafting.SINGLETON.addCraftable(cuttable);
		}
	}
