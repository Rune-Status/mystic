...
public class PrayerConstants {
	...
	public static final int[] DEFAULT_CONFIG_IDS = { 83, 84, 85, 700, 701, 86, 87, 88, 89, 90, 91, 702, 703, 92, 93, 94,
			95, 96, 97, 704, 705, 98, 99, 100, 706, 707 };

	public static final String[] DEFAULT_NAMES = { "Thick Skin", "Burst of Strength", "Clarity of Thought", "Sharp Eye",
			...
			"Protect from Magic", "Protect from Range", "Protect from Melee", "Eagle Eye", "Mystic Might",
	...
	private static final int[] getDefaultDisabledPrayers(int id) {
		...
		switch (id) {
		case 0:
			off = new int[] { 5, 13, 24, 25 };
			break;
		case 5:
			off = new int[] { 0, 13, 24, 25 };
			break;
		case 13:
			off = new int[] { 0, 5, 24, 25 };
			break;
		case 2:
			off = new int[] { 7, 15, 3, 4, 11, 12, 19, 20, 24, 25 };
			break;
		case 7:
			off = new int[] { 2, 15, 3, 4, 11, 12, 19, 20, 24, 25 };
			break;
		case 15:
			off = new int[] { 7, 2, 3, 4, 11, 12, 19, 20, 24, 25 };
			break;
		case 1:
			off = new int[] { 6, 14, 3, 4, 11, 12, 19, 20, 24, 25 };
			break;
		case 6:
			off = new int[] { 1, 14, 3, 4, 11, 12, 19, 20, 24, 25 };
			break;
		case 14:
			off = new int[] { 6, 1, 3, 4, 11, 12, 19, 20, 24, 25 };
			break;
		case 3:
			off = new int[] { 4, 11, 12, 19, 20, 1, 6, 14, 2, 7, 15, 24, 25 };
			break;
		case 11:
			off = new int[] { 4, 3, 12, 19, 20, 1, 6, 14, 2, 7, 15, 24, 25 };
			break;
		case 19:
			off = new int[] { 4, 11, 12, 3, 20, 1, 6, 14, 2, 7, 15, 24, 25 };
			break;
		case 4:
			off = new int[] { 3, 11, 12, 19, 20, 1, 6, 14, 2, 7, 15, 24, 25 };
			break;
		case 12:
			off = new int[] { 4, 11, 3, 19, 20, 1, 6, 14, 2, 7, 15, 24, 25 };
			break;
		case 20:
			off = new int[] { 4, 11, 12, 19, 3, 1, 6, 14, 2, 7, 15, 24, 25 };
			break;
		case 16:
			off = new int[] { 22, 23, 21, 17, 18 };
			break;
		case 17:
			off = new int[] { 22, 23, 21, 16, 18 };
			break;
		case 18:
			off = new int[] { 22, 23, 21, 17, 16 };
			break;
		case 21:
			off = new int[] { 22, 23, 18, 17, 16 };
			break;
		case 22:
			off = new int[] { 21, 23, 18, 17, 16 };
			break;
		case 23:
			off = new int[] { 22, 21, 18, 17, 16 };
			break;
		case 24:
			off = new int[] { 3, 4, 11, 12, 19, 20, 1, 6, 14, 2, 7, 15, 25, 0, 5, 13 };
			break;
		case 25:
			off = new int[] { 3, 4, 11, 12, 19, 20, 1, 6, 14, 2, 7, 15, 24, 0, 5, 13 };
		case 8:
		case 9:
		case 10:
		}
