...
public enum PrayerSounds {
	...
	BURST_OF_STRENGTH(1, 449),

	CLARITY_OF_THOUGHT(2, 436),

	ROCK_SKIN(5, 441),

	SUPERHUMAN_STRENGTH(6, 434),

	IMPROVED_REFLEXES(7, 448),
	...
	ULTIMATE_STRENGTH(14, 450),

	INCREDIBLE_REFLEXES(15, 440),

	PROTECT_FROM_MAGIC(16, 438),

	PROTECT_FROM_RANGED(17, 444),

	PROTECT_FROM_MELEE(18, 433);
