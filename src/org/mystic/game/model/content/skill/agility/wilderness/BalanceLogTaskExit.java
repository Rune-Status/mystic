...
public class BalanceLogTaskExit extends ForceMovementTask {

	private final int walk;
	private final boolean run;
	private final double exp;

	public BalanceLogTaskExit(Player player, Location l, double exp) {
	...
	@Override
	public void onStop() {
		TaskQueue.queue(new GateDoorExit2(player, 2998, 3917, 0, new Location(2998, 3916)));
	}
}