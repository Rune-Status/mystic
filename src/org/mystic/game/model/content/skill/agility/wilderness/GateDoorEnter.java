...
public class GateDoorEnter extends Task {
	...
	public GateDoorEnter(Player player, int x, int y, int z, Location dest) {
		super(player, 1, true);
		this.player = player;
	...
	@Override
	public void onStop() {
		TaskQueue.queue(new BalanceLogTask(player, new Location(2998, 3930, 0), 372));
	}
