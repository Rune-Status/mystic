...
public class SmithingConstants {
	...
	public static final int[][] TEXT_BAR_IDS = {

			{ 1124, 1125, 1126, 1127, 1128, 1129, 1130, 1131, 13357 }, // 1
	...
	public static boolean clickSmeltSelection(Player p, int id) {
		switch (id) {
		case 15147:
			TaskQueue.queue(new Smelting(p, 1, Bar.BRONZE_BAR));
			return true;
		case 15146:
			TaskQueue.queue(new Smelting(p, 5, Bar.BRONZE_BAR));
			return true;
		case 10247:
			TaskQueue.queue(new Smelting(p, 10, Bar.BRONZE_BAR));
			return true;
		case 9110:
			TaskQueue.queue(new Smelting(p, 28, Bar.BRONZE_BAR));
			return true;
		case 15151:
			TaskQueue.queue(new Smelting(p, 1, Bar.IRON_BAR));
			return true;
		case 15150:
			TaskQueue.queue(new Smelting(p, 5, Bar.IRON_BAR));
			return true;
		case 15149:
			TaskQueue.queue(new Smelting(p, 10, Bar.IRON_BAR));
			return true;
		case 15148:
			TaskQueue.queue(new Smelting(p, 28, Bar.IRON_BAR));
			return true;
		case 15155:
			TaskQueue.queue(new Smelting(p, 1, Bar.SILVER_BAR));
			return true;
		case 15154:
			TaskQueue.queue(new Smelting(p, 5, Bar.SILVER_BAR));
			return true;
		case 15153:
			TaskQueue.queue(new Smelting(p, 10, Bar.SILVER_BAR));
			return true;
		case 15152:
			TaskQueue.queue(new Smelting(p, 28, Bar.SILVER_BAR));
			return true;
		case 15159:
			TaskQueue.queue(new Smelting(p, 1, Bar.STEEL_BAR));
			return true;
		case 15158:
			TaskQueue.queue(new Smelting(p, 5, Bar.STEEL_BAR));
			return true;
		case 15157:
			TaskQueue.queue(new Smelting(p, 10, Bar.STEEL_BAR));
			return true;
		case 15156:
			TaskQueue.queue(new Smelting(p, 28, Bar.STEEL_BAR));
			return true;
		case 15163:
			TaskQueue.queue(new Smelting(p, 1, Bar.GOLD_BAR));
			return true;
		case 15162:
			TaskQueue.queue(new Smelting(p, 5, Bar.GOLD_BAR));
			return true;
		case 15161:
			TaskQueue.queue(new Smelting(p, 10, Bar.GOLD_BAR));
			return true;
		case 15160:
			TaskQueue.queue(new Smelting(p, 28, Bar.GOLD_BAR));
			return true;
		case 29017:
			TaskQueue.queue(new Smelting(p, 1, Bar.MITHRIL_BAR));
			return true;
		case 29016:
			TaskQueue.queue(new Smelting(p, 5, Bar.MITHRIL_BAR));
			return true;
		case 24253:
			TaskQueue.queue(new Smelting(p, 10, Bar.MITHRIL_BAR));
			return true;
		case 16062:
			TaskQueue.queue(new Smelting(p, 28, Bar.MITHRIL_BAR));
			return true;
		case 29022:
			TaskQueue.queue(new Smelting(p, 1, Bar.ADAMANITE_BAR));
			return true;
		case 29020:
			TaskQueue.queue(new Smelting(p, 5, Bar.ADAMANITE_BAR));
			return true;
		case 29019:
			TaskQueue.queue(new Smelting(p, 10, Bar.ADAMANITE_BAR));
			return true;
		case 29018:
			TaskQueue.queue(new Smelting(p, 28, Bar.ADAMANITE_BAR));
			return true;
		case 29026:
			TaskQueue.queue(new Smelting(p, 1, Bar.RUNITE_BAR));
			return true;
		case 29025:
			TaskQueue.queue(new Smelting(p, 5, Bar.RUNITE_BAR));
			return true;
		case 29024:
			TaskQueue.queue(new Smelting(p, 10, Bar.RUNITE_BAR));
			return true;
		case 29023:
			TaskQueue.queue(new Smelting(p, 28, Bar.RUNITE_BAR));
			return true;
		}
		return false;
	}
	...
	public static void sendSmeltSelectionInterface(Player p) {
		p.getClient().queueOutgoingPacket(new SendUpdateItems(2404, new Item[] { new Item(2349), new Item(2351),
				new Item(2353), new Item(2355), new Item(2357), new Item(2359), new Item(2361), new Item(2363) }));
		for (int i = 0; i < 9; i++) {
