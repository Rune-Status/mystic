...
public abstract class ItemContainer {
	...
	public boolean isStackable(int id) {
		return (type == ContainerTypes.ALWAYS_STACK) || ((Item.getDefinition(id) != null)
	...
	public BigInteger getContainerNet() {
		...
		for (Item item : items) {
			...
			toReturn = toReturn
					.add(new BigInteger(String.valueOf(GameDefinitionLoader.getStoreSellToValue(item.getId())))
