...
import org.mystic.game.model.entity.UpdateFlags;
...
public final class PlayerUpdateFlags {
	...
	public PlayerUpdateFlags(Player player) {
		...
		rights = ((byte) player.getRights().getProtocolValue());
		title = player.getRights().getTitle();
		combatLevel = ((byte) player.getSkill().getCombatLevel());
		combatLevelAddon = ((byte) player.getSkill().getSummoningAddition2());
		...
		username = Misc.capitalizeFirstLetter(player.getDisplay());
